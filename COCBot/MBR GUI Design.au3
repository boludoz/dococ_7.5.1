...
Global $g_hTabMain = 0, $g_hTabLog = 0, $g_hTabVillage = 0, $g_hTabAttack = 0, $g_hTabBot = 0, $g_hTabAbout = 0, $g_hTabMOD = 0 ; PICO MOD
...
#include "GUI\MBR GUI Design MOD.au3" ; PICO MOD
...
;~ ------------------------------------------------------
   ...
   $g_hTabMOD = GUICtrlCreateTabItem("Pico") ; PICO MOD
